...
Version 4.0: 04/01/2025 Updated known editions
Version 4.1: 05/20/2025 Removed a channel from supported editions.
#>
...
$SupportedEditions = @("Microsoft 365 Apps Update - Current Channel Version")
